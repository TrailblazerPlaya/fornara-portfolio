...
const skills = [
  ...
  { name: "Jest", description: "Мне не приходилось писать тесты в коммерческой разработке, но я также знаком с этой технологией. Для меня важно иметь документацию, чтобы глубже разобраться, но я также стремлюсь набраться больше практического опыта. В будущем я планирую освоить e2e и скриншотные тесты. ", icon: jestIcons},
